...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{threecolentry}{\textbf{PhD}}{
            ...
            \begin{highlights}
                \item GPA: 3.79/4.0 (\href{https://drive.google.com/file/d/1M7550b6c3y2ouXh2ZI5Z0Wn1COA5vaaq/view?usp=sharing}{Transcript}, \href{https://stat.illinois.edu/directory/profile/davidl11}{University Webpage})
                \item \textbf{Research:} stochastic processes, time series econometrics, supervised learning, reinforcement learning, point forecasts, density and quantile forecasts, forecast combination, model averaging, econometric analysis of shocks, panel data, volatility modeling, recession forecasting using ML
                ...
                \item Natural Language Processing (NLP) including Word2Vec, Doc2Vec, LDA, BERT, RAG, grounding and fine-tuning LLMs
                \end{itemize}
            \end{highlights}
        \end{threecolentry}
        ...
        \begin{threecolentry}{\textbf{MS}}{
            ...
            \begin{highlights}
                ...
                \begin{itemize} 
                    \item times series including ARIMA/GARCH/LSTM/GRU models, forecasting, changepoint detection
                    ...
                    \item biostatistics / causal inference, survival models, synthetic control, DiD, matching
                \end{itemize}
            \end{highlights}
        \end{threecolentry}
    ...
    \section{Experience}
        ...
        % }
        %     \textbf{Amazon}, Alexa and Amazon Devices, Data Science Intern
        %     \begin{highlights}
        %         \item prompt-engineering for and performance analysis of LLM-generated SQL syntax
        %         \item improving Alexa by generating synthetic \textit{Remarkable Alexa} data
    ...
    \section{Technological Skills}
        ...
        \begin{onecolentry}
            \textbf{Languages:} Python, R, Unix, C++, Java, SQL, Shiny
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Software:} AWS tech stack, PyTorch, TensorFlow, Keras, JAX, PySpark, pandas, polars, dash, ggplot
        \end{onecolentry} 
