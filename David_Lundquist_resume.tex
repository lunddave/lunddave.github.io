...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Last updated in November 2024}\hspace{\widthof{Last updated in August 2024}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \begin{header}
        ...
        \textbf{Applied Scientist and Statistical Software Engineer}
    ...
    \section{Education}
        ...
        \begin{threecolentry}{\textbf{PhD}}{
            ...
            \begin{highlights}
                ...
                \item Nonconvex optimization, gradient descent, linear and mixed integer programming
        ...
        \begin{threecolentry}{\textbf{MS}}{
            ...
            \begin{highlights}
                ...
                \begin{itemize} 
                    ...
                    \item  analysis of algorithms, data structures, complexity theory; cryptography (RSA, ECC)
