...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Last updated in January 2025}\hspace{\widthof{Last updated in August 2024}}
    }}}%
  }%
}%
    ...
    \section{Education}
        ...
        \begin{threecolentry}{\textbf{PhD}}{
            ...
            \begin{highlights}
                ...
                \item Natural Language Processing (NLP) including Word2Vec, Doc2Vec, LDA, Multimodal Transformers, RAG and fine-tuning, Diffusion Models (cts and discrete), Text2SQL
                \end{itemize}
            \end{highlights}
        \end{threecolentry}
